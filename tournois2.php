...
<body>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu ">
							<ul class="multi-column-dropdown">
								...
								<li><a href="tournois.php"><img alt="" src="images/tournois/summit8s.png" width="30" height="20"> Summit 8</a></li><br/>
								<li><a href="tournois2.php"><img alt="" src="images/tournois/mdlmacau.jpg" width="30" height="20"> MDL Macau<span class="sr-only">(current)</span></a></li><br/>
	...
	<div class="container "style="padding-bottom:50px">
			...
			<div class="col-lg-11">
				...
				<!-- Title -->
				<h1 class="mt-4">MDL Macau</h1>

				
				<hr>

				<!-- Preview Image -->
				<<img class="card-img-top" src="images/tournois/mdlmacau.jpg" width="750" height="300" alt="Card image cap">
