...
<body>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu ">
							<ul class="multi-column-dropdown">
								...
								<li><a href="tournois3.php"><img alt="" src="images/tournois/DHDLS8.png" width="30" height="20"> DreamLeague 8<span class="sr-only">(current)</span></a></li><br/>										
							</ul>
						</div>
					</li>
					<li class="nav-item">
	...
	<div class="container "style="padding-bottom:50px">
			...
			<div class="col-lg-11">
				...
				<!-- Title -->
				<h1 class="mt-4">DreamLeague Saison 8</h1>

				
				<hr>

				<!-- Preview Image -->
				<img class="card-img-top" src="images/tournois/DHDLS8.png" width="750" height="300" alt="Card image cap">
